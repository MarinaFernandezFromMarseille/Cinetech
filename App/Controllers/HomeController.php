...
class HomeController {
    ...
    public function getPopular() {
        ...
        return $data ?? []; // Renvoyer les résultats ou un tableau vide
    }
    ...
    public function getNowPlaying() {
        ...
        $response = file_get_contents($url);
        return json_decode($response, true) ?? ["no results"];
    }

}

$homeController = new HomeController();
$popularMovies = $homeController->getPopular();
$topRatedMovies = $homeController->getTopRated();
$upComingMovies = $homeController->getUpcoming();
$nowPlayingMovies = $homeController->getNowPlaying();
